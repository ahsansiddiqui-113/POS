...
exports.receiptPrinterService = exports.ReceiptPrinterService = void 0;
class ReceiptPrinterService {
    ...
    generateReceiptText(saleData) {
        ...
        for (const item of saleData.items) {
            ...
            receipt += this.rightAlign(`₱${item.subtotal.toFixed(2)}`, 12) + '\n';
        ...
        receipt += this.divider(width) + '\n';
        receipt += this.leftRight('TOTAL:', `₱${total.toFixed(2)}`, width, true) + '\n';
        receipt += this.divider(width) + '\n';
        // Footer message
    ...
    generateESCPOS(saleData) {
        ...
        // Sale info
        commands.push(10);
        this.addText(commands, `Date: ${this.formatDate(saleData.saleDate)}`);
        commands.push(10);
    ...
    leftRight(left, right, width, bold = false) {
    ...
    async saveReceiptAsFile(saleData, filePath) {
        try {
...
exports.receiptPrinterService = new ReceiptPrinterService();
//# sourceMappingURL=receiptPrinterService.js.map