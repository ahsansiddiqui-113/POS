...
exports.invoiceSettingsService = exports.InvoiceSettingsService = void 0;
...
class InvoiceSettingsService {
    constructor() {
        ...
        this.logoDir = path.join(process.cwd(), 'public', 'logos');
    ...
    getInvoiceSettings() {
        const settings = this.db
            ...
            .get();
        if (!settings) {
            throw new errorHandler_1.AppError(500, 'Invoice settings not initialized');
        }
        return settings;
    }
    ...
    uploadLogo(fileBuffer, fileName) {
        ...
        if (!ext || !allowedExtensions.includes(ext)) {
            throw new errorHandler_1.AppError(400, 'Invalid file type. Allowed: png, jpg, jpeg, gif');
        }
        const maxSize = 5 * 1024 * 1024; // 5MB
        if (fileBuffer.length > maxSize) {
            throw new errorHandler_1.AppError(400, 'File too large. Maximum size: 5MB');
        }
    ...
    generateInvoiceTemplate(saleId) {
        const sale = this.db
            .prepare(`
        SELECT
          s.id,
...
exports.invoiceSettingsService = new InvoiceSettingsService();
//# sourceMappingURL=invoiceSettingsService.js.map