...
class ReportService {
    ...
    getSalesAnalytics() {
        ...
        const todaySales = salesService_1.salesService.getSalesByDateRange(todayStr, todayStr);
        ...
        const weekSales = salesService_1.salesService.getSalesByDateRange(weekStartStr, weekEndStr);
        ...
        const monthSales = salesService_1.salesService.getSalesByDateRange(monthStart, monthEnd);
        const monthTotal = monthSales.reduce((sum, s) => sum + s.total_amount, 0);
        // This year's sales
        const yearStart = `${thisYear}-01-01`;
        const yearEnd = `${thisYear}-12-31`;
        const yearSales = salesService_1.salesService.getSalesByDateRange(yearStart, yearEnd);
        ...
        for (let i = 29; i >= 0; i--) {
            ...
            const daySales = salesService_1.salesService.getSalesByDateRange(dateStr, dateStr);
        ...
        for (let i = 11; i >= 0; i--) {
            ...
            const wSales = salesService_1.salesService.getSalesByDateRange(wStartStr, wEndStr);
        ...
        for (let i = 11; i >= 0; i--) {
            ...
            const mSales = salesService_1.salesService.getSalesByDateRange(mStart, mEnd);
        ...
        for (const row of yearsWithSales) {
            ...
            const ySales = salesService_1.salesService.getSalesByDateRange(yStart, yEnd);
